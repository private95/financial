...
public class OverSeasFund {
	...
	private Double topThreeMonth;         //三个月以来
	private Double topHalfYear;           //半年以来
	private Double topOne;                 //一年以来
	private Double topTwo;                 //两年以来
	private Double topThree;               //三年以来
	private Double topFive;                 //五年以来
	//private Double topDate;
	private Double top2018;                 //2018年
	private Double top2017;                 //以此类推
