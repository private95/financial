...
public class WeChatAuthController {
	...
	@RequestMapping(value = "/wxLoginPagess",method = RequestMethod.GET)
	@ResponseBody
    public Result wxLoginPage() throws Exception {
        String uri = weChatAuthService.getAuthorizationUrl();
        System.out.println("-->"+uri+"<------------------");
//        return loginPage(uri);https://private/svn/Finamcialpc/
