...
public class WeChatAuthServiceImpl extends DefaultAuthServiceImpl implements WeChatAuthService  {
	 ...
	 private Logger logger = LoggerFactory.getLogger(WeChatAuthServiceImpl.class);
	    ...
	    private static final String APP_ID="wx1611abf6bf19751a";
	    private static final String APP_SECRET="6266b5f319af20980809899cb42e6a8d";
	    private static final String SCOPE = "snsapi_userinfo";

	    private String callbackUrl = "https://www.donglongxun.com/url"; //回调域名


	//  String a = "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=wx1611abf6bf19751a&secret=6266b5f319af20980809899cb42e6a8d";
	 //access_token  11_rYHNtj-VLp53JvL2tYxUaMETCwQmpEXWOeKAFj8TvXODbuFVvB8NnMifh-IPeYUaKQ0Gk6Ew1B7vdZqYk_QykoS7Nq35cT9Lvdk9DCmK_hYNTbihG9rryKvNVbdFYZ2zjzUScDsN-ZhQXIEqAREeAFAMDQ
