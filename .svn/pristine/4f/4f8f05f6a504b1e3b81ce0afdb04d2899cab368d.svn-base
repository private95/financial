...
public class QQAuthServiceImpl extends DefaultAuthServiceImpl implements QQAuthService {
    ...
    // 下面的属性可以通过配置读取
    private  static final String CALLBACK_URL = "http://www.baidu.com"; // QQ 在登陆成功后回调的 URL，这个 URL 必须在 QQ 互联里填写过
    private  static final String API_KEY  = "1106965761";                                      // QQ 互联应用管理中心的 APP ID
    private  static final String API_SECRET = "ONksXQtlDHsxfutM";               // QQ 互联应用管理中心的 APP Key
