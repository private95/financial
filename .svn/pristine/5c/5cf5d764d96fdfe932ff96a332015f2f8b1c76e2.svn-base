...
SYS_CONFIG.game.push(['04','时时彩(JX)','kp']);
SYS_CONFIG.game.push(['07','七 乐 彩','mp']);
SYS_CONFIG.game.push(['20','时时彩(CQ)','kp']);
...
SYS_CONFIG.game.push(['71','混合(蓝彩)','jc']);
SYS_CONFIG.game.push(['94','胜负(蓝彩)','jc']);
SYS_CONFIG.game.push(['95','让分胜负(蓝彩)','jc']);
SYS_CONFIG.game.push(['96','胜分差(蓝彩)','jc']);
SYS_CONFIG.game.push(['97','大小分(蓝彩)','jc']);
...
SYS_CONFIG.state = [];
SYS_CONFIG.state.push(['','全部']);
SYS_CONFIG.state.push(['0','未处理']);
SYS_CONFIG.state.push(['1','已处理']);
SYS_CONFIG.getState = function(type){
	return GETSYSCOFIG(SYS_CONFIG.state, type);
};
SYS_CONFIG.success = [];
SYS_CONFIG.success.push(['','全部']);
SYS_CONFIG.success.push(['0','未处理']);
SYS_CONFIG.success.push(['1','提款成功']);
SYS_CONFIG.success.push(['2','拒接提款']);
SYS_CONFIG.success.push(['3','银行处理失败']);
SYS_CONFIG.getSuccess = function(type){
	return GETSYSCOFIG(SYS_CONFIG.success, type);
};
SYS_CONFIG.time = [];
SYS_CONFIG.time.push(['0','提款时间']);
SYS_CONFIG.time.push(['1','处理时间']);
SYS_CONFIG.getTime = function(type){
	return GETSYSCOFIG(SYS_CONFIG.time, type);
};
SYS_CONFIG.fSuccess = [];
SYS_CONFIG.fSuccess.push(['','全部']);
SYS_CONFIG.fSuccess.push(['0','未处理']);
SYS_CONFIG.fSuccess.push(['1','充值成功']);
SYS_CONFIG.getfSuccess = function(type){
	return GETSYSCOFIG(SYS_CONFIG.fSuccess, type);
};
SYS_CONFIG.ftime = [];
SYS_CONFIG.ftime.push(['0','充值时间']);
SYS_CONFIG.ftime.push(['1','到账时间']);
SYS_CONFIG.getfTime = function(type){
	return GETSYSCOFIG(SYS_CONFIG.ftime, type);
};
...
userLabel = function(a){
    var cnickid = location.search.getParam('cnickid');
	if(a==0){
		window.location="./userinfo.html?cnickid="+cnickid;
	}else if(a==1){
		window.location="./userquery.html?cnickid="+cnickid;
	}else if(a==2){
		window.location="./userdetail.html?cnickid="+cnickid;
	}else if(a==3){
		window.location="./charginginfo.html?cnickid="+cnickid;
	}else if(a==4){
		window.location="./drawinginfo.html?cnickid="+cnickid;
	}else if(a==5){
		window.location="./bettinginfo.html?cnickid="+cnickid;
	}else if(a==6){
		window.location="./subscribeinfo.html?cnickid="+cnickid;
	}else if(a==7){
		window.location="./afternumberinfo.html?cnickid="+cnickid;
	}else if(a==8){
		window.location="./recordinfo.html?cnickid="+cnickid;
	}else if(a==9){
		window.location="./mydocumentary.html?cnickid="+cnickid;
	}else if(a==10){
		window.location="./mysingle.html?cnickid="+cnickid;
	}else if(a==11){
		window.location="./autorecord.html?cnickid="+cnickid;
	}else if(a==12){
		window.location="./hongbao.html?cnickid="+cnickid;
	}
};